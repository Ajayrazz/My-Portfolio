import profilePic from "../assets/AjayProfile1.jpg";
        ...
        <div className="flex flex-wrap lg:flex-row-reverse">
            <div className="w-full lg:w-1/2">
                <div className="flex justify-center lg:p-8">
                    <motion.img src={profilePic} alt="Ajay Razz" className="border border-s-stone-900 rounded-3xl" 
                    width={650} 
                    height={650}
            ...
            <div className="w-full lg:w-1/2">
                ...
                variants={containerVariants}
                 className="flex flex-col items-center lg:items-start mt-10">
                    <motion.h2 variants={childVariants} className="pb-2 text-4xl tracking-tighter lg:text-8xl">Ajay Razz</motion.h2>
